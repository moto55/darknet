...
class Detector:
    ...
    def __init__(self, configPath = "./cfg/yolov3.cfg", weightPath = "yolov3.weights", metaPath= "./cfg/coco.data"):
        ...
        self.network_height = lib.network_height(self.netMain)
    ...
    def detect(self, image: np.ndarray, thresh=.5, hier_thresh=.5, nms=.45):
        ...
        img_resized = cv2.resize(image, (self.network_width, self.network_height))
    ...
    def _detect_image(self, thresh=.5, hier_thresh=.5, nms=.45, debug=False):
        ...
        predict_image(self.netMain, self.darknet_image)
        letter_box = 0
        #predict_image_letterbox(self.netMain, im)
        #letter_box = 1
